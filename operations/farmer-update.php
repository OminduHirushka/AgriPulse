...
$id = $_GET['updatedid'];
$sql = "SELECT * FROM farmars WHERE Farmer_ID = $id";
...
if (isset($_POST['update-btn'])) {
    ...
    $pass = $_POST["pass"];
    $sql = "UPDATE farmars SET Farmer_ID = $id, fname = '$fname', lname = '$lname', uname = '$uname', email = '$email', mobile = '$mobile', district = '$district', pass = '$pass' WHERE Farmer_ID = $id";
...
<head>
    <!--title-->
    <title>AgriPulse | Farmer - Update User Account</title>
        ...
        <div class="container">
            ...
            <form method="POST">
                ...
                <div class="text-center" style="margin-bottom: 2rem;">
                    <button class="btn btn-success btn-block fa-lg mb-3" type="submit" name="update-btn">Update</button>
                </div>
            </form>
        </div>
    </div>
