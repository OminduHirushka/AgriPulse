...
if (isset($_POST['update-btn'])) {
    ...
    $sql = "UPDATE officer SET Officer_ID = $id, fname = '$fname', lname = '$lname', uname = '$uname', email = '$email', mobile = '$mobile', district = '$district', pass = '$pass' WHERE Officer_ID = $id";
...
<head>
    <!--title-->
    <title>AgriPulse | Officer - Update User Account</title>
