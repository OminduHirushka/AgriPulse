...
if (isset($_POST['add-btn'])) {
    ...
    if ($pass != $confirm) {
        ...
        $sql = "INSERT INTO officer (fname, lname, uname, email, mobile, district, pass) 
...
<head>
    <!--title-->
    <title>AgriPulse | Add - Field Officer</title>
        ...
        <div class="container">
            <form method="POST">
                ...
                <div class="text-center" style="margin-bottom: 2rem;">
                    <button class="btn btn-success btn-block fa-lg" type="submit" name="add-btn">Add New Officer
                    </button>
                </div>
